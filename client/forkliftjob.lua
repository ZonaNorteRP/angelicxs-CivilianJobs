...
local Forklift_Options = {
    Boss = {
        ...
        Name = "João",
        tag = "EMPILHADOR",
        message = "👋 Olá, me chamo 😃**João Silva**, mas pode me chamar de **Seu João**.  \nVou te ensinar a como trabalhar aqui na 🏗️ empresa de empilhadeira. É bem simples!  \nTe daremos a empilhadeira e você pegará os paletes nos locais marcados e levará até os caminhões. 📦  \nUse o teclado numérico 5 e 8 para abaixar e levantar os garfos.  \nAgora larga mão de preguiça e vai trabalhar! 💼👊"
    },
    Sprite = {
        icon = 473,
        colour = 48,
        name = 'Empresa de J&J Logistica',
    },
    Forklift = {
    ...
    Payment = {
        flatRate = false,
        flatRateAmount = 100,
        DistanceMultiplier = 2.00, -- Only applies if flatRate = false, pays driver based on multiplying distance from pick up to drop off.
    },
}
    ...
    CreateThread(function()
        ...
        while true do
            ...
            if Dist <= 50 and not PedSpawned then
                TriggerEvent('angelicxs-CivilianJobs:MAIN:SpawnBossNPC', Forklift_Options.Boss.Model, Forklift_Options.Boss.Location, 'angelicxs-CivilianJobs:ForkliftJob:AskForWork', 'angelicxs-CivilianJobs:ForkliftJob:HowTo', ' ForkliftJob.lua', Forklift_Options)
                PedSpawned = true
