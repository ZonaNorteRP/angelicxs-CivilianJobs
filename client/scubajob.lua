...
local Scuba_Options = {
    ...
    Boss = {
        ...
        Name = "Pedro",
        tag = "MERGULHADOR",
        message = "👋 Olá, me chamo 😃**Pedro Costa**, mas pode me chamar de **Seu Pedro**.  \nVou te ensinar a como trabalhar aqui na 🤿 empresa de mergulho. É bem simples!  \nTe daremos o barco e você irá até as áreas marcadas para coletar caixas no fundo do mar. 🚤  \nUse o equipamento de mergulho para respirar debaixo d'água e colete as caixas.  \nAgora larga mão de preguiça e vai trabalhar! 💼👊"
    },
    Sprite = {
        icon = 729,
        colour = 48,
        name = 'Emprego de Mergulhador',
    },
    Boat = {
...
if Config.ScubaJobOn then
    ...
    CreateThread(function()
        ...
        while true do
            ...
            if Dist <= 50 and not PedSpawned then
                TriggerEvent('angelicxs-CivilianJobs:MAIN:SpawnBossNPC', Scuba_Options.Boss.Model, Scuba_Options.Boss.Location, 'angelicxs-CivilianJobs:ScubaJob:AskForWork', 'angelicxs-CivilianJobs:ScubaJob:HowTo', ' ScubaJob.lua', Scuba_Options)
                PedSpawned = true
    ...
    RegisterNetEvent('angelicxs-CivilianJobs:ScubaJob:SalvageCrate', function(crate, type)
        ...
        if DoesEntityExist(crate) then
            ...
            local closestObject = GetClosestObjectOfType(GetEntityCoords(ped), 5.5, GetHashKey(type), false, false, false, false, false)
        ...
        if object then
            ...
            if Scuba_Options.Payment.items then
                -- Dar 3 itens da caixa com delay para evitar anti-cheat
                for i = 1, 3 do
