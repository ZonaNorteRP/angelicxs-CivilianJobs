...
local Jetski_Options = {
    Boss = {
        ...
        Name = "Roberto",
        tag = "SALVA-VIDAS",
        message = "👋 Olá, me chamo 😃**Roberto Silva**, mas pode me chamar de **Seu Roberto**.  \nVou te ensinar a como trabalhar aqui na 🏖️ empresa de salva-vidas. É bem simples!  \nTe daremos o jet ski e você irá até os locais onde pessoas precisam de ajuda. 🚤  \nPegue as pessoas e traga de volta para a praia em segurança.  \nAgora larga mão de preguiça e vai trabalhar! 💼👊"
    },
    Sprite = {
        icon = 153,
        colour = 48,
        name = 'Emprego Salva Vidas',
    },
    Boat = {
...
if Config.JetSkiJobOn then
    CreateThread(function()
        ...
        while true do
            ...
            if Dist <= 50 and not PedSpawned then
                TriggerEvent('angelicxs-CivilianJobs:MAIN:SpawnBossNPC', Jetski_Options.Boss.Model, Jetski_Options.Boss.Location, 'angelicxs-CivilianJobs:JetskiJob:AskForWork', 'angelicxs-CivilianJobs:JetskiJob:HowTo', ' JetskiJob.lua', Jetski_Options)
                PedSpawned = true
    ...
    function grabSwimPed(coord)
        ...
        SetEntityCoords(swimPed, coord.x, coord.y, coord.z+1, false, false, false, false)
    ...
    function SwimDropLocation(inital)
        ...
        CreateThread(function()
            ...
            if DoesEntityExist(MissionVehicle) then
                TriggerEvent('angelicxs-CivilianJobs:Notify', Config.Lang['jetski_searching'], Config.LangType['info'])
                Wait(3000)
                TriggerEvent('angelicxs-CivilianJobs:JetskiJob:BeginWork')
            end
        end)
